...
const INTERNAL_CARD_TYPES = ["news", "competition", "job", "birthday", "slide", "invitation"]
...
const NEWS_SECONDS: Record<string, number> = { stats: 12, job: 20, competition: 16, invitation: 18 }
