 ...
 * screens read only this project — the Drift service key is used here, server-
 * side only. Scheduled ~14:00 Norwegian time (12:00 & 13:00 UTC, see vercel.json);
 * idempotent upserts, so running twice is harmless.
 */
