      ...
      <div className="fx-rise" style={{ animationDelay: "180ms" }}>
        <SoftTable>
          <SoftThead>
            ...
            <SoftTh className="text-right">Butikker</SoftTh>
            <SoftTh className="text-right">Skjermer</SoftTh>
            <SoftTh className="text-right">Brukere</SoftTh>
            <SoftTh className="text-right">Innhold</SoftTh>
            <SoftTh />
          </SoftThead>
          <tbody>
            {overview.map((t) => {
              ...
              return (
                <SoftTr key={t.id}>
                  ...
                  <SoftTd className="text-right tabular-nums text-zinc-700">
                    {t.storeCount}
                  </SoftTd>
                  <SoftTd className="text-right tabular-nums text-zinc-700">
                  ...
                  <SoftTd className="text-right">
                    <form action={setActiveTenant.bind(null, t.id)}>
                      <button
                        type="submit"
                        className="rounded-full bg-zinc-900 px-3.5 py-1.5 text-sm font-medium text-white shadow-sm transition-all hover:bg-zinc-700 hover:shadow active:scale-[0.98] disabled:opacity-50 disabled:shadow-none"
                        disabled={isActive}
                      >
