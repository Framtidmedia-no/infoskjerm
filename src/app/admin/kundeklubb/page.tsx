      ...
      <div className="flex-1 p-6 max-w-5xl space-y-5">
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
          <div className="rounded-2xl border border-zinc-200/80 bg-white p-4 shadow-[0_1px_2px_rgba(16,24,40,0.04)]">
            ...
            <p className="font-display mt-1 text-2xl font-bold tabular-nums tracking-tight text-zinc-900">{totalMembers}</p>
          </div>
          <div className="rounded-2xl border border-zinc-200/80 bg-white p-4 shadow-[0_1px_2px_rgba(16,24,40,0.04)]">
            ...
            <p className="font-display mt-1 text-2xl font-bold tabular-nums tracking-tight text-zinc-900">{(stores ?? []).filter((s) => s.kundeklubb_enabled).length}</p>
          </div>
        </div>
