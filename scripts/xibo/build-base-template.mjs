 ...
 * fallback layout. News filtered by date-window only; weather defaults to Ålesund.
 *
 * Run from repo root:  node scripts/xibo/build-base-template.mjs
 */

import { loadEnv, getToken, makeApi, weatherUri, tickerUri, buildLayout, DATE_WINDOW } from "./lib.mjs"
